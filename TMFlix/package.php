...
<div class="body">
	...
	<table>
		<thead>
			<tr>
				<th>&nbsp &nbsp Package ID</th>
				<th>Package Type</th>
				<th>Package Price</th>
				<th>Allowed Number of Devices</th>
			</tr>
		</thead>
<?php	
include "connection.php";
$sql = "SELECT Package_ID, Package_Type, Package_Price, Package_Allowed_Device FROM package;";
...
?>					
			...
			<tr>
				<td><label>&nbsp &nbsp<?php echo $row['Package_ID']; ?></label></td>
				<td><label><?php echo $row['Package_Type']; ?></label></td>
				<td><label><?php echo $row['Package_Price']; ?></label></td>
				<td><label><?php echo $row['Package_Allowed_Device']; ?></label></td>
