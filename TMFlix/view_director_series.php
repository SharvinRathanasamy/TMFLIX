...
$ID = $_GET['identity'];
$sql = "SELECT Director_Name, Director_ID FROM director WHERE Director_ID='$ID';";
...
<html>
<head>
		<title><?php echo $name;?>- Director-Series</title>
