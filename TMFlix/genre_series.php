...
<h3>Available Gener</h3>
	...
	<table>
		<thead>
			<tr>
				<th>&nbsp &nbsp &nbsp &nbsp Genre ID</th>
				<th>Gener</th>
				<th>Go To</th>
			</tr>
		</thead>
...
?>					
			...
			<tr>
				<td><label>&nbsp &nbsp &nbsp &nbsp <?php echo $row['Genres_ID']; ?></label></td>
			    <td><label><?php echo $row['Genres_Type']; ?></label></td>
				<td><a href ="view_genre-series.php? identity=<?php echo $row['Genres_ID']?> "><button class="button button2">Series</button></td>
			</tr>
